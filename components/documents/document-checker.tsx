...
const categories: Category[] = [
  {
    ...
    borderColor: 'border-[rgba(99,102,241,0.3)]',
    documentTypes: [
      {
        id: 'passport-fresh',
...
Generated by ClearCase - Your Legal Document Assistant
  ...
  const getTypeBadgeStyles = (type: 'original' | 'photocopy' | 'both') => {
    switch (type) {
      ...
      case 'both': return 'bg-[rgba(99,102,241,0.15)] text-[#6366f1] border-[rgba(99,102,241,0.3)]'
    }
  }
          ...
          >
            ...
            <div className="mb-6 p-4 rounded-xl bg-[rgba(255,255,255,0.03)] border border-[rgba(255,255,255,0.06)]">
              <div className="flex items-center justify-between mb-3">
                ...
                <span className={`text-sm font-semibold ${progress === 100 ? 'text-green-400' : 'text-[#6366f1]'}`}>
                  {progress}%
                </span>
              </div>
              <div className="h-2 bg-[rgba(255,255,255,0.05)] rounded-full overflow-hidden">
                <motion.div
                  ...
                  className={`h-full rounded-full ${progress === 100 ? 'bg-gradient-to-r from-green-500 to-emerald-400' : 'bg-[#6366f1]'}`}
                />
              </div>
            ...
            <div className="flex flex-wrap gap-3 mb-6">
              <div className="flex items-center gap-2 px-4 py-2.5 rounded-lg bg-[rgba(99,102,241,0.1)] border border-[rgba(99,102,241,0.2)]">
                <Clock className="w-4 h-4 text-[#6366f1]" />
                <span className="text-sm text-[#6366f1]">{selectedDocType.estimatedTime}</span>
              </div>
              <div className="flex items-center gap-2 px-4 py-2.5 rounded-lg bg-[rgba(16,185,129,0.1)] border border-[rgba(16,185,129,0.2)]">
                <IndianRupee className="w-4 h-4 text-[#10b981]" />
                <span className="text-sm text-[#10b981]">{selectedDocType.totalEstimatedCost}</span>
              </div>
              <div className="flex items-center gap-2 px-4 py-2.5 rounded-lg bg-[rgba(139,92,246,0.1)] border border-[rgba(139,92,246,0.2)]">
                <MapPin className="w-4 h-4 text-[#8b5cf6]" />
                <span className="text-sm text-[#8b5cf6]">{selectedDocType.whereToApply}</span>
              </div>
              {selectedDocType.applyLink && (
                <a
                  ...
                  className="flex items-center gap-2 px-4 py-2.5 rounded-lg bg-[rgba(99,102,241,0.1)] border border-[rgba(99,102,241,0.2)] hover:bg-[rgba(99,102,241,0.15)] transition-colors"
                >
                  <ExternalLink className="w-4 h-4 text-[#6366f1]" />
                  <span className="text-sm text-[#6366f1]">Apply Online</span>
                </a>
              )}
            </div>
                    ...
                    >
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {doc.notes && (
                            <p className="mt-2 text-xs text-[#6366f1] flex items-center gap-1">
            ...
            <div className="mt-6 flex flex-col sm:flex-row gap-4">
              <motion.button
                ...
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl bg-[#6366f1] hover:bg-[#4f46e5] text-white font-semibold shadow-lg shadow-[rgba(99,102,241,0.25)] hover:shadow-[rgba(99,102,241,0.4)] transition-shadow"
              >
